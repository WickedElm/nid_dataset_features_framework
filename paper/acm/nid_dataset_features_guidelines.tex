...
\centering
    ...
    \caption{
        A typical directory for features that will be generated with our implementation's wrapper scripts.
        ...
        Depicted with blue text are updates made by a downstream researcher to add a new feature generated using the Zeek tool to augment the features of the original dataset.
    }
